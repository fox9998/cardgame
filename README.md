# Μάθημα: Πολυμέσα και Παιγνιοποίηση
## Επαύξηση με αρχεία .jpg (2D εικόνες)
...
### Δημιουργία ψηφιακού περιεχομένου
Κάθε marker πρέπει να αντιστοιχεί σε ψηφιακό περιεχόμενο που θα έχει σκοπό να εμπλουτίσει την εμπειρία του χρήστη. H δημιουργία του ψηφιακού περιεχομένου αφορά jpg αρχεία (εικόνες)
